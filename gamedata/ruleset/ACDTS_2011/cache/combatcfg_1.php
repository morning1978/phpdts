...
$ex_wep_dmg = Array('p' => 10, 'u' => 5, 'i'=> 12, 'd'=> 2,'e' => 10,'w' => 12);
//各种属性攻击的伤害熟练参数，越小伤害上升越快
$ex_skill_dmg = Array('p' => 15, 'u' => 20, 'i'=> 20 ,'d'=> 500,'e' => 20,'w' => 15);
//各种属性攻击的伤害浮动范围
$ex_dmg_fluc = Array('p' => 15, 'u' => 30, 'i'=> 10,'d'=> 20,'e' => 5,'w' => 15);
//属性攻击导致的异常状态登录
$ex_inf = Array('p' => 'p', 'u' => 'u', 'i'=> 'i','e' => 'e','w' => 'w');
//已经进入异常状态对属性攻击伤害的影响
$ex_inf_punish = Array('p' => 2, 'u' => 1, 'i'=> 0.75,'e' => 1,'w'=>1.5);
//各种属性攻击的初始致异常状态率
$ex_inf_r = Array('p' => 5, 'u' => 10, 'i'=> 5,'e' => 5,'w'=> 5);
//各种属性攻击的最高致异常状态率
$ex_max_inf_r = Array('p' => 60, 'u' => 40, 'i'=> 50,'e' => 50,'w'=> 40);
//熟练度对致异常状态率的影响
$ex_skill_inf_r = Array('p' => 0.1, 'u' => 0.05, 'i'=> 0.08,'e' => 0.08,'w'=>0.08);
